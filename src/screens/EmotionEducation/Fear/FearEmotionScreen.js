...
const audio1 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear1.wav'));
const audio2 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear2.wav'));
const audio3 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear3.wav'));
const audio4 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear4.wav'));
const audio5 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear5.wav'));
const audio6 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear6.wav'));
const audio7 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear7.wav'));
const audio8 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear8.wav'));
const audio9 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear9.wav'));
const audio10 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear10.wav'));
const audio11 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear11.wav'));
const audio12 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear12.wav'));
const audio13 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear13.wav'));
const audio14 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear14.wav'));
const audio15 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear15.wav'));
const audio16 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear16.wav'));
const audio17 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear17.wav'));
const audio18 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear18.wav'));
const audio19 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear19.wav'));
const audio20 = new Sound(require('../../../../assets/Emotions/Audio/Fear/fear20.wav'));




const FearEmotionScreen = () => {
  ...
  const playAudio1 = () => {
    setImage1(require('../../../../assets/Emotions/Images/Fear/fear1.jpg'));
    audio1.play((success) => {
      if (success) {
        setMessage1('Fear Man');
      } else {
  ...
  const playAudio2 = () => {
    setImage2(require('../../../../assets/Emotions/Images/Fear/fear2.jpg'));
    audio2.play((success) => {
      if (success) {
        setMessage2('Fear Man');
      } else {
  ...
  const playAudio3 = () => {
    setImage3(require('../../../../assets/Emotions/Images/Fear/fear3.jpg'));
    audio3.play((success) => {
      if (success) {
        setMessage3('Fear Man');
      } else {
  ...
  const playAudio4 = () => {
    setImage4(require('../../../../assets/Emotions/Images/Fear/fear8.jpg'));
    audio4.play((success) => {
      if (success) {
        setMessage4('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio5 = () => {
    setImage5(require('../../../../assets/Emotions/Images/Fear/fear9.jpg'));
    audio5.play((success) => {
      if (success) {
        setMessage5('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio6 = () => {
    setImage6(require('../../../../assets/Emotions/Images/Fear/fear10.jpg'));
    audio6.play((success) => {
      if (success) {
        setMessage6('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio7 = () => {
    setImage7(require('../../../../assets/Emotions/Images/Fear/fear11.jpg'));
    audio7.play((success) => {
      if (success) {
        setMessage7('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio8 = () => {
    setImage8(require('../../../../assets/Emotions/Images/Fear/fear12.jpg'));
    audio8.play((success) => {
      if (success) {
        setMessage8('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio9 = () => {
    setImage9(require('../../../../assets/Emotions/Images/Fear/fear18.jpg'));
    audio9.play((success) => {
      if (success) {
        setMessage9('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio10 = () => {
    setImage10(require('../../../../assets/Emotions/Images/Fear/fear19.jpg'));
    audio10.play((success) => {
      if (success) {
        setMessage10('Fear Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio11 = () => {
    setImage11(require('../../../../assets/Emotions/Images/Fear/fear4.jpg'));
    audio11.play((success) => {
      if (success) {
        setMessage11('Fear Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio12 = () => {
    setImage12(require('../../../../assets/Emotions/Images/Fear/fear5.jpg'));
    audio12.play((success) => {
      if (success) {
        setMessage12('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio13 = () => {
    setImage13(require('../../../../assets/Emotions/Images/Fear/fear6.jpg'));
    audio13.play((success) => {
      if (success) {
        setMessage13('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio14 = () => {
    setImage14(require('../../../../assets/Emotions/Images/Fear/fear7.jpg'));
    audio14.play((success) => {
      if (success) {
        setMessage14('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio15 = () => {
    setImage15(require('../../../../assets/Emotions/Images/Fear/fear13.jpg'));
    audio15.play((success) => {
      if (success) {
        setMessage15('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio16 = () => {
    setImage16(require('../../../../assets/Emotions/Images/Fear/fear14.jpg'));
    audio16.play((success) => {
      if (success) {
        setMessage16('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio17 = () => {
    setImage17(require('../../../../assets/Emotions/Images/Fear/fear15.jpg'));
    audio17.play((success) => {
      if (success) {
        setMessage17('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio18 = () => {
    setImage18(require('../../../../assets/Emotions/Images/Fear/fear6.jpg'));
    audio18.play((success) => {
      if (success) {
        setMessage18('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio19 = () => {
    setImage19(require('../../../../assets/Emotions/Images/Fear/fear17.jpg'));
    audio19.play((success) => {
      if (success) {
        setMessage19('Fear Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio20 = () => {
    setImage20(require('../../../../assets/Emotions/Images/Fear/fear20.jpg'));
    audio20.play((success) => {
      if (success) {
        setMessage20('Fear Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
...
export default FearEmotionScreen;