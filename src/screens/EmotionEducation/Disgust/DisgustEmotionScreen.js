...
const audio1 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust1.wav'));
const audio2 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust2.wav'));
const audio3 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust3.wav'));
const audio4 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust4.wav'));
const audio5 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust5.wav'));
const audio6 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust6.wav'));
const audio7 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust7.wav'));
const audio8 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust8.wav'));
const audio9 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust9.wav'));
const audio10 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust10.wav'));
const audio11 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust11.wav'));
const audio12 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust12.wav'));
const audio13 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust13.wav'));
const audio14 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust14.wav'));
const audio15 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust15.wav'));
const audio16 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust16.wav'));
const audio17 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust17.wav'));
const audio18 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust18.wav'));
const audio19 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust19.wav'));
const audio20 = new Sound(require('../../../../assets/Emotions/Audio/Disgust/disgust20.wav'));




const DisgustEmotionScreen = () => {
  ...
  const playAudio1 = () => {
    setImage1(require('../../../../assets/Emotions/Images/Disgust/disgust3.jpg'));
    audio1.play((success) => {
      if (success) {
        setMessage1('Disgusted Man');
      } else {
  ...
  const playAudio2 = () => {
    setImage2(require('../../../../assets/Emotions/Images/Disgust/disgust7.jpg'));
    audio2.play((success) => {
      if (success) {
        setMessage2('Disgusted Man');
      } else {
  ...
  const playAudio3 = () => {
    setImage3(require('../../../../assets/Emotions/Images/Disgust/disgust8.jpg'));
    audio3.play((success) => {
      if (success) {
        setMessage3('Disgusted Man');
      } else {
  ...
  const playAudio4 = () => {
    setImage4(require('../../../../assets/Emotions/Images/Disgust/disgust9.jpg'));
    audio4.play((success) => {
      if (success) {
        setMessage4('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio5 = () => {
    setImage5(require('../../../../assets/Emotions/Images/Disgust/disgust13.jpg'));
    audio5.play((success) => {
      if (success) {
        setMessage5('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio6 = () => {
    setImage6(require('../../../../assets/Emotions/Images/Disgust/disgust16.jpg'));
    audio6.play((success) => {
      if (success) {
        setMessage6('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio7 = () => {
    setImage7(require('../../../../assets/Emotions/Images/Disgust/disgust17.jpg'));
    audio7.play((success) => {
      if (success) {
        setMessage7('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio8 = () => {
    setImage8(require('../../../../assets/Emotions/Images/Disgust/disgust18.jpg'));
    audio8.play((success) => {
      if (success) {
        setMessage8('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio9 = () => {
    setImage9(require('../../../../assets/Emotions/Images/Disgust/disgust19.jpg'));
    audio9.play((success) => {
      if (success) {
        setMessage9('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio10 = () => {
    setImage10(require('../../../../assets/Emotions/Images/Disgust/disgust20.jpg'));
    audio10.play((success) => {
      if (success) {
        setMessage10('Disgusted Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio11 = () => {
    setImage11(require('../../../../assets/Emotions/Images/Disgust/disgust1.jpg'));
    audio11.play((success) => {
      if (success) {
        setMessage11('Disgusted Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio12 = () => {
    setImage12(require('../../../../assets/Emotions/Images/Disgust/disgust2.jpg'));
    audio12.play((success) => {
      if (success) {
        setMessage12('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio13 = () => {
    setImage13(require('../../../../assets/Emotions/Images/Disgust/disgust4.jpg'));
    audio13.play((success) => {
      if (success) {
        setMessage13('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio14 = () => {
    setImage14(require('../../../../assets/Emotions/Images/Disgust/disgust5.jpg'));
    audio14.play((success) => {
      if (success) {
        setMessage14('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio15 = () => {
    setImage15(require('../../../../assets/Emotions/Images/Disgust/disgust6.jpg'));
    audio15.play((success) => {
      if (success) {
        setMessage15('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio16 = () => {
    setImage16(require('../../../../assets/Emotions/Images/Disgust/disgust10.jpg'));
    audio16.play((success) => {
      if (success) {
        setMessage16('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio17 = () => {
    setImage17(require('../../../../assets/Emotions/Images/Disgust/disgust11.jpg'));
    audio17.play((success) => {
      if (success) {
        setMessage17('Disgusted Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio18 = () => {
    setImage18(require('../../../../assets/Emotions/Images/Disgust/disgust12.jpg'));
    audio18.play((success) => {
      if (success) {
        setMessage18('Disgusted Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio19 = () => {
    setImage19(require('../../../../assets/Emotions/Images/Disgust/disgust14.jpg'));
    audio19.play((success) => {
      if (success) {
        setMessage19('Disgusted Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio20 = () => {
    setImage20(require('../../../../assets/Emotions/Images/Disgust/disgust15.jpg'));
    audio20.play((success) => {
      if (success) {
        setMessage20('Disgusted Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
...
export default DisgustEmotionScreen;