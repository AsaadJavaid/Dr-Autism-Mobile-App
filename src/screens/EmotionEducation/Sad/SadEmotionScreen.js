...
const audio1 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad1.wav'));
const audio2 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad2.wav'));
const audio3 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad3.wav'));
const audio4 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad4.wav'));
const audio5 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad5.wav'));
const audio6 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad6.wav'));
const audio7 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad7.wav'));
const audio8 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad8.wav'));
const audio9 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad9.wav'));
const audio10 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad10.wav'));
const audio11 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad11.wav'));
const audio12 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad12.wav'));
const audio13 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad13.wav'));
const audio14 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad14.wav'));
const audio15 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad15.wav'));
const audio16 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad16.wav'));
const audio17 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad17.wav'));
const audio18 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad18.wav'));
const audio19 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad19.wav'));
const audio20 = new Sound(require('../../../../assets/Emotions/Audio/Sad/sad20.wav'));




const SadEmotionScreen = () => {
  ...
  const playAudio1 = () => {
    setImage1(require('../../../../assets/Emotions/Images/Sad/sad1.jpg'));
    audio1.play((success) => {
      if (success) {
        setMessage1('Sad Man');
      } else {
  ...
  const playAudio2 = () => {
    setImage2(require('../../../../assets/Emotions/Images/Sad/sad2.jpg'));
    audio2.play((success) => {
      if (success) {
        setMessage2('Sad Man');
      } else {
  ...
  const playAudio3 = () => {
    setImage3(require('../../../../assets/Emotions/Images/Sad/sad6.jpg'));
    audio3.play((success) => {
      if (success) {
        setMessage3('Sad Man');
      } else {
  ...
  const playAudio4 = () => {
    setImage4(require('../../../../assets/Emotions/Images/Sad/sad7.jpg'));
    audio4.play((success) => {
      if (success) {
        setMessage4('Sad Man');
      } else {
  ...
  const playAudio5 = () => {
    setImage5(require('../../../../assets/Emotions/Images/Sad/sad10.jpg'));
    audio5.play((success) => {
      if (success) {
        setMessage5('Sad Man');
      } else {
  ...
  const playAudio6 = () => {
    setImage6(require('../../../../assets/Emotions/Images/Sad/sad11.jpg'));
    audio6.play((success) => {
      if (success) {
        setMessage6('Sad Man');
      } else {
  ...
  const playAudio7 = () => {
    setImage7(require('../../../../assets/Emotions/Images/Sad/sad13.jpg'));
    audio7.play((success) => {
      if (success) {
        setMessage7('Sad Man');
      } else {
  ...
  const playAudio8 = () => {
    setImage8(require('../../../../assets/Emotions/Images/Sad/sad15.jpg'));
    audio8.play((success) => {
      if (success) {
        setMessage8('Sad Man');
      } else {
  ...
  const playAudio9 = () => {
    setImage9(require('../../../../assets/Emotions/Images/Sad/sad16.jpg'));
    audio9.play((success) => {
      if (success) {
        setMessage9('Sad Man');
      } else {
  ...
  const playAudio10 = () => {
    setImage10(require('../../../../assets/Emotions/Images/Sad/sad17.jpg'));
    audio10.play((success) => {
      if (success) {
        setMessage10('Sad Man');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio11 = () => {
    setImage11(require('../../../../assets/Emotions/Images/Sad/sad20.jpg'));
    audio11.play((success) => {
      if (success) {
        setMessage11('Sad Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio12 = () => {
    setImage12(require('../../../../assets/Emotions/Images/Sad/sad3.jpg'));
    audio12.play((success) => {
      if (success) {
        setMessage12('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio13 = () => {
    setImage13(require('../../../../assets/Emotions/Images/Sad/sad4.jpg'));
    audio13.play((success) => {
      if (success) {
        setMessage13('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio14 = () => {
    setImage14(require('../../../../assets/Emotions/Images/Sad/sad5.jpg'));
    audio14.play((success) => {
      if (success) {
        setMessage14('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio15 = () => {
    setImage15(require('../../../../assets/Emotions/Images/Sad/sad8.jpg'));
    audio15.play((success) => {
      if (success) {
        setMessage15('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio16 = () => {
    setImage16(require('../../../../assets/Emotions/Images/Sad/sad9.jpg'));
    audio16.play((success) => {
      if (success) {
        setMessage16('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio17 = () => {
    setImage17(require('../../../../assets/Emotions/Images/Sad/sad12.jpg'));
    audio17.play((success) => {
      if (success) {
        setMessage17('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio18 = () => {
    setImage18(require('../../../../assets/Emotions/Images/Sad/sad14.jpg'));
    audio18.play((success) => {
      if (success) {
        setMessage18('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio19 = () => {
    setImage19(require('../../../../assets/Emotions/Images/Sad/sad18.jpg'));
    audio19.play((success) => {
      if (success) {
        setMessage19('Sad Woman');
      } else {
        console.log('Error playing audio 3');
      }
    });
  ...
  const playAudio20 = () => {
    setImage20(require('../../../../assets/Emotions/Images/Sad/sad19.jpg'));
    audio20.play((success) => {
      if (success) {
        setMessage20('Sad Women');
      } else {
        console.log('Error playing audio 3');
      }
    });
...
export default SadEmotionScreen;